...
namespace Mario
{
    public class GreenKoopaTroopa : IEnemy, ICollidable
    {
        ...
        public GreenKoopaTroopa(SpriteFactory myFactory, int myX, int myY)
        {
            State = "left";
            Factory = myFactory;
            CurrentSprite = Factory.GetSprite("Green_Koopa_Unshelled_Walk_Left");
            X = myX * 32;
            Y = myY * 32;
        ...
        public void Collision()
        {
            ...
            if (State == "left")
            {
                CurrentSprite = Factory.GetSprite("Green_Koopa_Unshelled_Walk_Right");
                State = "right";
            }
            else if (State == "right")
            {
